(function() {
  if (window.top === window.self) {
    console.log('LS: injection -> ' + window.location.href);
    const tabId = Math.random() * 16;
    let currentUrl, killYTAutoplayInt, hideYTAvatarInt;
    ...
    const saReport = function () {
      ...
      console.log('LS: logging -> ' + JSON.stringify(body));
    ...
    const checkYoutube = function() {
      if (window.location.href.match(/(^|\.)youtube\./)) {
        console.log('LS: YouTube detected');
        applyYouTube();
      };
    }
    ...
    const applyYouTube = function () {
      ...
      xhr.onreadystatechange = function () {
        if (this.status === 200 && xhr.responseText) {
          ...
          console.log('LS: YouTube settings -> ' + JSON.stringify(ytSettings));
    ...
    const blockYTImg = '/522675c8e566c8eeb53a06be383e5a78f4460bd5d3e6f5b56e9c6ba2413722e5/blocked-image.png';
...
setupFlagScanning([], ["*palmbeachschools.org*","*palmbeach.k12.fl.us*","*mysdpbc.org*","*sdpbc.org*","107.23.190.247*","*flpbis.org*","*provexam.com*","ncta.memberclicks.net*","*palmbeachschools.diversitycompliance.com*","*craigslist.com*","*translate.googleusercontent.com/translate_c*","*sites.google.com/site/personalgaminwebsite/home/games*","*sites.google.com/site/bestunblockedgames66/douchebag-workout*","*sites.google.com/site/*gaming*","*web.archive.org*","*findyourlovemate.net*","*creditoacumuladoicms.com.br*","*herokuapp.com/proxy/*","*.herokuapp.com/proxy/*","*sites.google.com/site/soenixs*","*sites.google.com/view/theadvancedmethod*","*sites.google.com/site/projectr3fr3shwebsite*","*unblocked-games.s3.amazonaws.com*","*cbc.ca/kids/games*","*sites.google.com/a/tps501.org*","*sites.google.com/site/projectyeet1*","*sites.google.com/site/subgfyfs*","*bestdecision.agency*","*redetillu.casa*","*rojjoness.digital*","*sporticyber.bid*","weighteroperter.top","defliressisto.top","zasatava.top","*sites.google.com/site/*unblock*","*centr-epilacia.ru*","*.thedad.com*","https://www.smarttech.com/en/Feeds/software/iq/tips","*sites.google.com/view/2playergameunblocked*","https://github.com/elitwo/joe","*google.com/logos/fnbx/snake_arcade*","*google.com/logos/2010/pacman10-hp.png","*google.com/logos/pacman10-hp-sprite-3.png","http://download.wavebrowser.co","*/assets/js/common-1628457888.js","*shared-document.clouds-july.workers.dev*","https://remotedesktop.google.com/access","meet.google.com/bqo-hmma-azv","*.herokuapp.com/protectpage.html*","*luketest00.herokuapp.com*","suspiciousmeaslydownloads*","shh--noahfoster3.*","offensivebustlingdirectories.*","*neelsvilles-node*","www.google.com/logos/2010/pacman10-i.html","https://gorescript.github.io/*","https://www.engineering.com/gamespuzzles/motherload/tabid/4708/","ubg100.gitlab.io","https://www.sites.google.com/view/zaks-hub/*","*lego.com/en-us/kids/games*","*sites.google.com/site/*game*","*sites.google.com/view/*game*","*/amusements/games/tetris*","http://welovegatos.com/wp-content/plugins/super-links/application/helpers/super-links-proxy.php?https://1v1.lol/#","https://sites.google.com/view/zaks-hub/*","https://sites.google.com/view/sealflix/*","https://sites.google.com/view/sealcentral/*","https://sites.google.com/view/glizzygobbbler9000/*","https://deprexx00.github.io/*","pasco.com/help/sparkvue/index.html","sites.google.com/stu.palmbeachschools.org/ent4l/*","https://github.com/glixzzy/*","https://sites.google.com/view/tubgexclusives/*","https://sites.google.com/view/math-2235/*","https://sites.google.com/view/tubg/*","*browncha023*","*sites.google.com/view/play-funblocked/*","https://en.wikipedia.org/wiki/List_of_emoticons","grandcanyonshuttles.com/uploads/*","sites.google.com/view/totallynottubgexclusives/*","sites.google.com/stu.palmbeachschools.org/learning-resources/testing-page","*sites.google.com/view/math-42424424*","https://sites.google.com/view/ac-wiki-games/*","*sites.google.com/view/totallynottubgexclusives*","https://s3-eu-west-1.amazonaws.com/apps.playcanvas.com/*","localhost"]);
